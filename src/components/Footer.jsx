...
const footerLinks = {
  Programs: [
    { label: "Strength Training", to: "/programs/strength-training" },
    { label: "Cardio Training", to: "/programs/cardio-training" },
    { label: "Fat Burning", to: "/programs/fat-burning" },
    { label: "Health Fitness", to: "/programs/health-fitness" },
  ],
  Company: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-surface-400 text-sm leading-relaxed max-w-sm mb-6">
              Transform your body and mind with world-class training. Join the
              APEX community and discover what you're truly capable of.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-surface-400 hover:text-white hover:bg-primary-500/20 hover:border-primary-500/30 transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
