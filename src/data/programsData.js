export const programsData = [
  {
    ...
    fullDescription:
      "Our Strength Training program is a comprehensive, periodized approach to building raw power and functional muscle. Whether you're a beginner learning the foundational compound movements or an advanced lifter chasing a new PR, our expert coaches design progressive programs tailored to your body and goals.",
    duration: "60–90 min",
    frequency: "3–5x per week",
    level: "All Levels",
    benefits: [
      "Build lean muscle mass and increase metabolic rate",
      "Improve bone density and joint health",
      "Boost functional strength for everyday activities",
      "Enhance athletic performance across all sports",
      "Reduce risk of injury through balanced muscle development",
      "Improve posture and body mechanics",
    ],
    schedule: [
      { day: "Monday", focus: "Upper Body Push — Chest, Shoulders, Triceps" },
      { day: "Tuesday", focus: "Lower Body — Squats, Lunges, Deadlifts" },
      { day: "Wednesday", focus: "Active Recovery & Mobility" },
      { day: "Thursday", focus: "Upper Body Pull — Back, Biceps, Rear Delts" },
      { day: "Friday", focus: "Full Body Power — Olympic Lifts & Compounds" },
      { day: "Saturday", focus: "Accessory Work & Weak Point Training" },
    ],
    equipment: ["Barbells & Plates", "Dumbbells", "Cable Machines", "Squat Racks", "Kettlebells", "Resistance Bands"],
  },
  {
    ...
    fullDescription:
      "Our Cardio Training program is engineered to elevate your cardiovascular endurance, torch calories, and build unstoppable stamina. From high-intensity interval training to steady-state endurance work, we structure sessions that keep your heart rate in the optimal zone for maximum fat oxidation and conditioning.",
    duration: "30–50 min",
    frequency: "3–5x per week",
    level: "All Levels",
    benefits: [
      "Dramatically improve cardiovascular health and VO2 max",
      "Burn significant calories during and after workouts (EPOC effect)",
      "Boost energy levels and reduce daily fatigue",
      "Improve mental clarity and reduce stress hormones",
      "Strengthen heart muscle and lower resting heart rate",
      "Enhance endurance for sports and daily activities",
    ],
    schedule: [
      { day: "Monday", focus: "HIIT Intervals — 30 sec sprint / 30 sec rest x 20" },
      { day: "Tuesday", focus: "Steady-State Zone 2 Cardio — 40 min" },
      { day: "Wednesday", focus: "Active Recovery — Yoga & Light Walking" },
      { day: "Thursday", focus: "Tabata Circuit — 4 min blocks x 5 rounds" },
      { day: "Friday", focus: "Tempo Run / Bike — Progressive Intensity" },
      { day: "Saturday", focus: "Fun Cardio — Group Sports or Outdoor Session" },
    ],
    equipment: ["Treadmills", "Rowing Machines", "Assault Bikes", "Jump Ropes", "Battle Ropes", "StairMasters"],
  },
  {
    slug: "fat-burning",
    ...
    fullDescription:
      "Our Fat Burning program combines the science of metabolic conditioning with high-intensity training to maximize calorie burn and accelerate fat loss. Each session is designed to spike your metabolism and keep it elevated for hours after your workout, turning your body into a fat-burning machine around the clock.",
    duration: "45–60 min",
    frequency: "4–5x per week",
    level: "Beginner to Intermediate",
    benefits: [
      "Maximize calorie burn with metabolic conditioning circuits",
      "Accelerate fat loss while preserving lean muscle mass",
      "Boost your resting metabolic rate for all-day calorie burn",
      "Improve insulin sensitivity and hormonal balance",
      "Build lean, toned physique with functional movements",
      "Develop mental toughness and discipline",
    ],
    schedule: [
      { day: "Monday", focus: "Metabolic Circuit — Full Body Compound Supersets" },
      { day: "Tuesday", focus: "HIIT Cardio + Core Finisher" },
      { day: "Wednesday", focus: "Active Recovery — Light Cardio & Stretching" },
      { day: "Thursday", focus: "Strength-Cardio Hybrid — Heavy Lifts + Sprints" },
      { day: "Friday", focus: "EMOM Training — Every Minute on the Minute" },
      { day: "Saturday", focus: "Long Duration Burn — 60 min Endurance Circuit" },
    ],
    equipment: ["Kettlebells", "Medicine Balls", "TRX Suspension", "Plyo Boxes", "Sled Push/Pull", "Ropes"],
  },
  {
    slug: "health-fitness",
    ...
    details:
      "This program is designed for those who exercise for body fitness, not bodybuilding.",
    fullDescription:
      "Our Health Fitness program takes a holistic approach to wellness, focusing on overall body fitness, flexibility, balance, and mental well-being rather than pure muscle building. Perfect for those who want to stay active, feel great, and maintain a healthy lifestyle without the intensity of competitive training.",
    duration: "45–60 min",
    frequency: "3–4x per week",
    level: "All Levels",
    benefits: [
      "Improve overall cardiovascular and respiratory health",
      ...
      "Boost immune system function and longevity",
      "Build sustainable, lifelong fitness habits",
    ],
    schedule: [
      { day: "Monday", focus: "Functional Movement — Mobility & Light Resistance" },
      { day: "Tuesday", focus: "Low-Impact Cardio — Swimming, Cycling, or Elliptical" },
      { day: "Wednesday", focus: "Yoga & Mindfulness Session" },
      { day: "Thursday", focus: "Full Body Circuit — Bodyweight & Light Weights" },
      { day: "Friday", focus: "Flexibility & Recovery — Foam Rolling & Stretching" },
      { day: "Saturday", focus: "Outdoor Activity — Hiking, Walking, or Group Sport" },
    ],
    equipment: ["Yoga Mats", "Foam Rollers", "Resistance Bands", "Stability Balls", "Light Dumbbells", "Balance Boards"],
  },
];
